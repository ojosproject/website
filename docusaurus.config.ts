    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          {
            from: "/docs/url/requirements/",
            to: "/docs/palliview/requirements/",
          },
          {
            from: "/docs/url/engineers/design/",
            to: "/docs/palliview/design/",
          },
          {
            from: "/docs/url/engineers/Documentation/",
            to: "/docs/palliview/Documentation/",
          },
          {
            from: "/docs/url/engineers/Engineering-Modelsl/",
            to: "/docs/palliview/Engineering-Models/",
          },
          {
            from: "/docs/url/engineers/liscensing/",
            to: "/docs/palliview/liscensing/",
          },
          {
            from: "/docs/url/engineers/palliview-digital-models/",
            to: "/docs/palliview/palliview-digital-models/",
          },
        ],
      },
    ],
